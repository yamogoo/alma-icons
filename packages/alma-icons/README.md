...
![Version](https://img.shields.io/badge/version-2.14.0-green)
...
The library includes **1107 icons** (552 outline, 555 fill) built on a consistent **100–500 weight stroke system** with a stable, versioned taxonomy.

Perfect for design systems, product interfaces, and long-term UI development.

- **1107 icons** (552 outline, 555 fill)
