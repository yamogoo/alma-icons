...
The library includes **1153 icons** (575 outline, 578 fill) built on a consistent **100–500 weight stroke system** with a stable, versioned taxonomy.

Perfect for design systems, product interfaces, and long-term UI development.

- **1153 icons** (575 outline, 578 fill)
